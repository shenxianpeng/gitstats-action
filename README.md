...
> [!TIP]
> The examples below use `@v1`, which automatically tracks the latest v1.x release.
> Pin to an exact version (e.g. `shenxianpeng/gitstats-action@v1.0.0`) if you prefer strict stability.
